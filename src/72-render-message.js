...
function appendTyping() {
  ...
  div.innerHTML=`<div class="msg-hdr"><div class="msg-av ai">LCL</div><div class="msg-role">${(creds?.model||'LCL')}${typeof clsSuffix === 'function' ? clsSuffix(creds) : ''}</div></div><div class="msg-body"><div class="typing"><span></span><span></span><span></span></div></div>`
